...
class MainWindow : public QMainWindow {
 ...
 public:
  MainWindow(const QMap<QString, QSize> &customSizeHints, QWidget *parent = 0,
  ...
  inline InteractiveProperties *interactiveProperties() {
    return m_InteractiveProperties;
  }
 ...
 private:
  ...
  void showExactNumberOfResourceWhenMouseHover(QObject *watched,
                                               const bool isShowExact);
