...
#define REG_CLOCK (phost->GpuDefs->RegClock)
#define REG_CMD_READ (phost->GpuDefs->RegCmdRead)
#define REG_CMD_WRITE (phost->GpuDefs->RegCmdWrite)
#define REG_CMD_DL (phost->GpuDefs->RegCmdDl)
#define REG_CMDB_SPACE (phost->GpuDefs->RegCmdBSpace)
#define REG_CMDB_WRITE (phost->GpuDefs->RegCmdBWrite)
#define REG_TRIM (phost->GpuDefs->RegTrim)
#define REG_FREQUENCY (phost->GpuDefs->RegFrequency)
#define REG_DLSWAP (phost->GpuDefs->RegDlSwap)
#define REG_ID (phost->GpuDefs->RegId)
#define REG_CPURESET (phost->GpuDefs->RegCpuReset)
#define REG_HCYCLE (phost->GpuDefs->RegHCycle)
#define REG_HOFFSET (phost->GpuDefs->RegHOffset)
#define REG_HSYNC0 (phost->GpuDefs->RegHSync0)
#define REG_HSYNC1 (phost->GpuDefs->RegHSync1)
#define REG_VCYCLE (phost->GpuDefs->RegVCycle)
#define REG_VOFFSET (phost->GpuDefs->RegVOffset)
#define REG_VSYNC0 (phost->GpuDefs->RegVSync0)
#define REG_VSYNC1 (phost->GpuDefs->RegVSync1)
#define REG_SWIZZLE (phost->GpuDefs->RegSwizzle)
#define REG_PCLK_POL (phost->GpuDefs->RegPClkPol)
#define REG_HSIZE (phost->GpuDefs->RegHSize)
#define REG_VSIZE (phost->GpuDefs->RegVSize)
#define REG_CSPREAD (phost->GpuDefs->RegCSpread)
#define REG_DITHER (phost->GpuDefs->RegDither)
#define REG_TOUCH_RZTHRESH (phost->GpuDefs->RegTouchRzThresh)
#define REG_GPIO_DIR (phost->GpuDefs->RegGpioDir)
#define REG_GPIO (phost->GpuDefs->RegGpio)
#define REG_PCLK (phost->GpuDefs->RegPclk)
#define REG_PLAYBACK_PLAY (phost->GpuDefs->RegPlaybackPlay)
#define REG_SPI_WIDTH (phost->GpuDefs->RegSpiWidth)
