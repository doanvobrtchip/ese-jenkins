...
// The list of Python Highlighted Identifier keywords
const char *QsciLexerPython::keyword2Class =
    "True False None"
    "abs all any ascii bin bool bytearray bytes callable chr classmethod"
    "compile complex delattr dict dir divmod enumerate eval exec filter"
    "float format frozentset getattr globals hasattr hash help hex id"
