...
void KeyboardClass::update()
{
	...
	digitalWrite(FT800EMU_DIGITAL_LEFT, keystate[SDLK_LEFT] ? LOW : HIGH);
	digitalWrite(FT800EMU_DIGITAL_RIGHT, keystate[SDLK_RIGHT] ? LOW : HIGH);
	digitalWrite(FT800EMU_DIGITAL_UP, keystate[SDLK_UP] ? LOW : HIGH);
	digitalWrite(FT800EMU_DIGITAL_DOWN, keystate[SDLK_DOWN] ? LOW : HIGH);
	digitalWrite(FT800EMU_DIGITAL_SHOOT, keystate[SDLK_SPACE] ? LOW : HIGH);
