...
private:
	static BT8XXEMU_FORCE_INLINE void rawWriteU32(ramaddr address, uint32_t data);
	static BT8XXEMU_FORCE_INLINE uint32_t rawReadU32(ramaddr address);
	static BT8XXEMU_FORCE_INLINE void rawWriteU16(ramaddr address, uint16_t data);
	static BT8XXEMU_FORCE_INLINE uint16_t rawReadU16(ramaddr address);
	static BT8XXEMU_FORCE_INLINE void rawWriteU8(ramaddr address, uint8_t data);
	static BT8XXEMU_FORCE_INLINE uint8_t rawReadU8(ramaddr address);

	template<typename T>
	static BT8XXEMU_FORCE_INLINE void actionWrite(const ramaddr address, T &data);
	template<typename T>
	static BT8XXEMU_FORCE_INLINE void postWrite(const ramaddr address, T data);
...
BT8XXEMU_FORCE_INLINE void MemoryClass::rawWriteU32(uint8_t *buffer, ramaddr address, uint32_t data)
{
	*static_cast<uint32_t *>(static_cast<void *>(&buffer[address])) = data;
}

BT8XXEMU_FORCE_INLINE uint32_t MemoryClass::rawReadU32(uint8_t *buffer, ramaddr address)
{
	return *static_cast<uint32_t *>(static_cast<void *>(&buffer[address]));
}

BT8XXEMU_FORCE_INLINE void MemoryClass::rawWriteU16(uint8_t *buffer, ramaddr address, uint16_t data)
{
	*static_cast<uint16_t *>(static_cast<void *>(&buffer[address])) = data;
}

BT8XXEMU_FORCE_INLINE uint16_t MemoryClass::rawReadU16(uint8_t *buffer, ramaddr address)
{
	return *static_cast<uint16_t *>(static_cast<void *>(&buffer[address]));
}

BT8XXEMU_FORCE_INLINE void MemoryClass::rawWriteU8(uint8_t *buffer, ramaddr address, uint8_t data)
{
	buffer[address] = data;
}

BT8XXEMU_FORCE_INLINE uint8_t MemoryClass::rawReadU8(uint8_t *buffer, ramaddr address)
{
