...
#define FT800EMU_REG_ROTATE_MIRROR_ALL(ram) ((ram[REG_ROTATE] & 0x1) != 0)
#define FT800EMU_REG_ROTATE_PORTRAIT(ram) ((ram[REG_ROTATE] & 0x2) != 0)
#define FT800EMU_REG_ROTATE_MIRROR_X(ram) ((ram[REG_ROTATE] & 0x4) != 0)
#define FT800EMU_REG_ROTATE_MIRROR_HORIZONTAL(ram) FT800EMU_REG_ROTATE_MIRROR_ALL(ram) ^ FT800EMU_REG_ROTATE_MIRROR_X(ram) // (! ((FT800EMU_REG_ROTATE_MIRROR_ALL(ram) && (!FT800EMU_REG_ROTATE_MIRROR_X(ram) || FT800EMU_REG_ROTATE_PORTRAIT(ram))) || (FT800EMU_REG_ROTATE_MIRROR_X(ram) && !FT800EMU_REG_ROTATE_PORTRAIT(ram)))
#define FT800EMU_REG_ROTATE_MIRROR_VERTICAL(ram) FT800EMU_REG_ROTATE_MIRROR_ALL(ram) // ((FT800EMU_REG_ROTATE_MIRROR_ALL(ram) && (!FT800EMU_REG_ROTATE_MIRROR_X(ram) || !FT800EMU_REG_ROTATE_PORTRAIT(ram))) || (FT800EMU_REG_ROTATE_MIRROR_X(ram) && FT800EMU_REG_ROTATE_PORTRAIT(ram)))
#define FT800EMU_REG_ROTATE_SWAP_XY(ram) FT800EMU_REG_ROTATE_PORTRAIT(ram)
#else
