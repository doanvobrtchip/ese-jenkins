	...
	m_LineEditor(NULL), m_LineNumber(0)
{
	...
	m_Bitmaps->setIcon(0, QIcon(":/icons/map-resize.png"));
	{
		...
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_HANDLE));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Bitmap Source"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_SOURCE));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Bitmap Layout"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_LAYOUT));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Bitmap Size"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_SIZE));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Transform A"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_TRANSFORM_A));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Transform B"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_TRANSFORM_B));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Transform C"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_TRANSFORM_C));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Transform D"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_TRANSFORM_D));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Transform E"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_TRANSFORM_E));
		item = new QTreeWidgetItem(m_Bitmaps);
		item->setText(0, tr("Transform F"));
		item->setData(1, Qt::UserRole, QVariant((uint)3));
		item->setData(2, Qt::UserRole, QVariant((uint)FT800EMU_DL_BITMAP_TRANSFORM_F));
		item = new QTreeWidgetItem(m_Bitmaps);
